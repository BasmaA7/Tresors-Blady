<footer class="bottom-0 w-full text-white py-8 bg-customColor">

  <div class="container mx-auto flex flex-wrap justify-between mt-8">
      <!-- Colonne 1 -->
  ...
  <div class="text-center mt-8">
      <p>&copy; 2024 Pape Toulé Yade. Tous droits réservés.</p>
  </div>
</footer>